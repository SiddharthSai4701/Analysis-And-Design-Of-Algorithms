...
This program solves the 0/1 Knapsack problem using the greedy method
...
# I've defined a function that sorts a list of tuples containing tuples in ascending order using Bubble Sort
...
print("The objects selected are: ",selected)
